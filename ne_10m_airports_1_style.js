...
function categories_ne_10m_airports_1(feature, value, size, resolution, labelText,
                ...
                switch(valueStr) {case 'Major Aiport':
                    return [ new ol.style.Style({
        image: new ol.style.Circle({radius: 6.000000000000002 + size,
            displacement: [0, 0], stroke: new ol.style.Stroke({color: 'rgba(35,35,35,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0.0}), fill: new ol.style.Fill({color: 'rgba(249,15,155,1.0)'})}),
...
case 'Small Aiport':
        ...
        image: new ol.style.Circle({radius: 3.6 + size,
            displacement: [0, 0], stroke: new ol.style.Stroke({color: 'rgba(35,35,35,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0.0}), fill: new ol.style.Fill({color: 'rgba(244,234,46,1.0)'})}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
